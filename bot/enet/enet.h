...
typedef struct _ENetHost
{
   ...
   ENetSocket socks5_tcp;
   size_t usingProxy;
   ENetAddress          gtaddress;
...
ENET_API ENetPeer * enet_host_connect (ENetHost *, const ENetAddress *, const ENetAddress *, ProxyInfo*, size_t, enet_uint32);
